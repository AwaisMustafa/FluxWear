...
const About = () => {
  ...
  return (
    ...
    >
      <h1 className="text-3xl md:text-5xl font-bold mb-6 text-center">About FluxWear</h1>

      <p className="md:text-xl text-1xl mb-12 text-center max-w-3xl">
        FluxWear is a modern streetwear brand bringing stylish, high-quality hoodies to men, women, and unisex fashion lovers.
        ...
        and crafted to keep you looking fresh while feeling comfortable. Join the FluxWear community and embrace your urban lifestyle.
      </p>

            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10">
                ...
                <div className="lg:w-1/2 flex flex-col gap-6">
                    ...
                    <p className="text-1xl sm:text-1xl md:text-lg">
                        FluxWear is a modern streetwear brand dedicated to providing high-quality, stylish hoodies for men, women, and unisex fashion enthusiasts.
                ...
                <div className="lg:w-1/2">
                    <img
                        src="/Unisex_Hoodies_Collections/bg5.jpg"
                        alt="FluxWear Hoodies"
